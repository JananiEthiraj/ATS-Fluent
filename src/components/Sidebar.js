...
const Sidebar = (props) => {
  ...
  const [isCollapseIconCalloutOpen, setIsCollapseIconCalloutOpen] =
    useState(false);
  ...
  return (
    <div
      className={`${styles.sidebar_container} ${
        isCollapsed ? styles.sidebar_container_collapsed : ""
      }`}
    >
      <div className={styles.sidebar_items_container}>
        ...
        <Sidebaritem
          handleNavigation={() => handleNavigation("demandreport/demandstatus")}
          id="demand"
          title={"Demand Report"}
          isActive={mainPath === "demandreport"}
          sideIcon={demandreport}
          onMouseEnter={(e) => iconHoverHandler(e, "demandreport")}
          onMouseLeave={(e) => iconHoverHandler(e, "")}
          callout={
            currentIconCallout === "demandreport" && (
              <Callout
                role="dialog"
                target={"#demand"}
                isBeakVisible={false}
              ...
              >
                ...
                <DefaultButton
                  className={`${styles.sidebar_sub_btn} 
						 ${subPath === "managedemands" ? styles.sidebar_sub_btn_active : ""}`}
                  onClick={() => handleNavigation("demandreport/managedemands")}
                >
                  <div className={cx("submenu-container")}>
                    <img
                      className={cx("submenu-img")}
                ...
                <DefaultButton
                  className={`${styles.sidebar_sub_btn} 
						 ${subPath === "demandstatus" ? styles.sidebar_sub_btn_active : ""}`}
                  onClick={() => handleNavigation("demandreport/demandstatus")}
                >
                  <div className={cx("submenu-container")}>
                    <img
                      className={cx("submenu-img")}
        ...
        >
          <DefaultButton
            className={`${styles.sidebar_sub_btn} 
						${subPath === "adddemands" ? styles.sidebar_sub_btn_active : ""}`}
            onClick={() => handleNavigation("demandreport/adddemands")}
          >
            <div className={cx("submenu-container")}>
        ...
        <Sidebaritem
          handleNavigation={() => handleNavigation("submissionlisting")}
          title={"Submission Report"}
          sideIcon={submission}
          isActive={mainPath === "submissionlisting"}
          singleItem={true}
        />

        <Sidebaritem
          title={"Candidate"}
          handleNavigation={() => handleNavigation("candidate/viewsubmission")}
          sideIcon={candidateicon}
          isActive={mainPath === "candidate"}
          id={"Candidate"}
          onMouseEnter={(e) => iconHoverHandler(e, "candidate")}
          onMouseLeave={(e) => iconHoverHandler(e, "")}
          callout={
            currentIconCallout === "candidate" && (
              <Callout
                role="dialog"
                calloutMaxWidth={200}
                gapSpace={0}
              ...
              >
                <DefaultButton
                  className={`${styles.sidebar_sub_btn} 
							${subPath === "addcandidate" ? styles.sidebar_sub_btn_active : ""}`}
                  onClick={() => handleNavigation("candidate/addcandidate")}
                >
                  <div className={cx("submenu-container")}>
                    <img
                      className={cx("submenu-img")}
                ...
                <DefaultButton
                  className={`${styles.sidebar_sub_btn} 
							${subPath === "viewsubmission" ? styles.sidebar_sub_btn_active : ""}`}
                  onClick={() => handleNavigation("candidate/viewsubmission")}
                >
                  <div className={cx("submenu-container")}>
                    <img
                      className={cx("submenu-img")}
        ...
        <Sidebaritem
          ...
          sideIcon={reports}
          handleNavigation={() =>
            handleNavigation("reports/recruitersubmission")
          }
          isActive={mainPath === "reports"}
          id={"reports"}
          onMouseEnter={(e) => iconHoverHandler(e, "reports")}
          onMouseLeave={(e) => iconHoverHandler(e, "")}
          callout={
            currentIconCallout === "reports" && (
              <Callout
                role="dialog"
                calloutMaxWidth={240}
                gapSpace={0}
              ...
              >
                <DefaultButton
                  className={`${styles.sidebar_sub_btn} 
						${subPath === "recruitersubmission" ? styles.sidebar_sub_btn_active : ""}`}
                  onClick={() =>
                    handleNavigation("reports/recruitersubmission")
                  }
                >
                ...
                <DefaultButton
                  className={`${styles.sidebar_sub_btn} 
						${subPath === "leaddemand" ? styles.sidebar_sub_btn_active : ""}`}
                  onClick={() => handleNavigation("reports/leaddemand")}
                >
                  <div className={cx("submenu-container")}>
                    <img
                      className={cx("submenu-img")}
                ...
                <DefaultButton
                  className={`${styles.sidebar_sub_btn} 
						${subPath === "accountmanager" ? styles.sidebar_sub_btn_active : ""}`}
                  onClick={() => handleNavigation("reports/accountmanager")}
                >
                  <div className={cx("submenu-container")}>
                    <img
                      className={cx("submenu-img")}
                ...
                <DefaultButton
                  className={`${styles.sidebar_sub_btn} 
						${subPath === "clientreport" ? styles.sidebar_sub_btn_active : ""}`}
                  onClick={() => handleNavigation("reports/clientreport")}
                >
                  <div className={cx("submenu-container")}>
                    <img
                      className={cx("submenu-img")}
                ...
                <DefaultButton
                  className={`${styles.sidebar_sub_btn} 
						${subPath === "subvendorsubmission" ? styles.sidebar_sub_btn_active : ""}`}
                  onClick={() =>
                    handleNavigation("reports/subvendorsubmission")
                  }
                >
                  <div className={cx("submenu-container")}>
                    <img
                      className={cx("submenu-img")}
                      src={subvendorsubmissions}
                      alt=""
                    />
                    <div className={cx("submenu-title")}>
                      Sub Vendor Submissions{" "}
                    </div>
                  </div>
                </DefaultButton>
                ...
                <DefaultButton
                  className={`${styles.sidebar_sub_btn} 
						${subPath === "clientreportcount" ? styles.sidebar_sub_btn_active : ""}`}
                  onClick={() => handleNavigation("reports/clientreportcount")}
                >
                  <div className={cx("submenu-container")}>
                    <img
                      className={cx("submenu-img")}
                      src={clientreportcount}
                      alt=""
                    />
                    <div className={cx("submenu-title")}>
                      Client Report Count{" "}
        ...
        >
          <DefaultButton
            className={`${styles.sidebar_sub_btn} 
						${subPath === "recruitersubmission" ? styles.sidebar_sub_btn_active : ""}`}
            onClick={() => handleNavigation("reports/recruitersubmission")}
          >
            <div className={cx("submenu-container")}>
              <img
                className={cx("submenu-img")}
          ...
          <DefaultButton
            className={`${styles.sidebar_sub_btn} 
						${subPath === "subvendorsubmission" ? styles.sidebar_sub_btn_active : ""}`}
            onClick={() => handleNavigation("reports/subvendorsubmission")}
          >
            <div className={cx("submenu-container")}>
              <img
                className={cx("submenu-img")}
        ...
        <Sidebaritem
          title={"Master Page"}
          sideIcon={masterpage}
          handleNavigation={() => handleNavigation("masterpage/addskills")}
          isActive={mainPath === "masterpage"}
          id={"masterpage"}
          onMouseEnter={(e) => iconHoverHandler(e, "masterpage")}
          onMouseLeave={(e) => iconHoverHandler(e, "")}
          callout={
            currentIconCallout === "masterpage" && (
              <Callout
                role="dialog"
                calloutMaxWidth={240}
                gapSpace={0}
              ...
              >
                <DefaultButton
                  className={`${styles.sidebar_sub_btn} 
						${subPath === "addskills" ? styles.sidebar_sub_btn_active : ""}`}
                  onClick={() => handleNavigation("masterpage/addskills")}
                >
                  <div className={cx("submenu-container")}>
                ...
                <DefaultButton
                  className={`${styles.sidebar_sub_btn} 
						${subPath === "addlocation" ? styles.sidebar_sub_btn_active : ""}`}
                  onClick={() => handleNavigation("masterpage/addlocation")}
                >
                  <div className={cx("submenu-container")}>
                    <img
                      className={cx("submenu-img")}
                ...
                <DefaultButton
                  className={`${styles.sidebar_sub_btn} 
						${subPath === "addclient" ? styles.sidebar_sub_btn_active : ""}`}
                  onClick={() => handleNavigation("masterpage/addclient")}
                >
                  <div className={cx("submenu-container")}>
                ...
                <DefaultButton
                  className={`${styles.sidebar_sub_btn} 
						${subPath === "addsubmissionstatus" ? styles.sidebar_sub_btn_active : ""}`}
                  onClick={() =>
                    handleNavigation("masterpage/addsubmissionstatus")
                  }
                >
                  <div className={cx("submenu-container")}>
                    <img
                      className={cx("submenu-img")}
                      src={addsubmissionstatus}
                      alt=""
                    />
                    <div className={cx("submenu-title")}>
                      {" "}
                ...
                <DefaultButton
                  className={`${styles.sidebar_sub_btn} 
						${subPath === "addsubvendor" ? styles.sidebar_sub_btn_active : ""}`}
                  onClick={() => handleNavigation("masterpage/addsubvendor")}
                >
                  <div className={cx("submenu-container")}>
                    <img
                      className={cx("submenu-img")}
        ...
        >
          ...
          <DefaultButton
            className={`${styles.sidebar_sub_btn} 
						${subPath === "addsubmissionstatus" ? styles.sidebar_sub_btn_active : ""}`}
            onClick={() => handleNavigation("masterpage/addsubmissionstatus")}
          >
            <div className={cx("submenu-container")}>
              <img
                className={cx("submenu-img")}
        ...
        <Sidebaritem
          ...
          sideIcon={teammanagement}
          handleNavigation={() =>
            handleNavigation("teammanagement/manageemployee")
          }
          isActive={mainPath === "teammanagement"}
          id={"teammanagement"}
          onMouseEnter={(e) => iconHoverHandler(e, "teammanagement")}
          onMouseLeave={(e) => iconHoverHandler(e, "")}
          callout={
            currentIconCallout === "teammanagement" && (
              <Callout
                role="dialog"
                calloutMaxWidth={200}
                gapSpace={0}
              ...
              >
                ...
                <DefaultButton
                  ...
                  onClick={() =>
                    handleNavigation("teammanagement/assignemployee")
                  }
                >
                  <div className={cx("submenu-container")}>
                    <img
      ...
      <div className={styles.collapse_icon_separator_container}>
        <div className={styles.collapse_separator_container}>
          <div className={styles.collapse_separator}></div>
        </div>

        <div
          id={"collapseId"}
          onClick={clickCollapseHandler}
          onMouseEnter={collapseIconOverHandler}
          onMouseLeave={collapseIconOverHandler}
        ...
        >
          {isCollapseIconCalloutOpen && isCollapsed && (
            <Callout
              target={"#collapseId"}
              isBeakVisible={false}
              popupProps={{ className: styles.collapse_icon_callout_container }}
              role="dialog"
              gapSpace={0}
              setInitialFocus
          ...
          <img
            className={cx("collapse-icon", { icon_collapsed: isCollapsed })}
            src={collapseicon}
            alt="collapse icon"
          />
        </div>
