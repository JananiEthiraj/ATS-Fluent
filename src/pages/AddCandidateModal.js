											...
											<tr className={styles.table_row}>
												...
												<td className={styles.table_dataContents}>
													<div className={(employeeData.dateOfHire || errors.dateOfHire ) ? styles.showfield : styles.hidefield } >
														<DatePicker placeholder='DD/MM/YYYY' onSelectDate={(date)=>dateHandler(date,'dateOfHire')} 
...
{/* <div className={styles.main_from_field}>
									...
									<div className={styles.main_sub_from_field}>
										...
										<div className={(employeeData.dateOfJoin || errors.dateOfJoin) ? styles.showfield : styles.hidefield } >
												<DatePicker placeholder='DD/MM/YYYY' onSelectDate={(date)=>dateHandler(date,'dateOfJoin')} 
												isRequired={errors.dateOfJoin}styles={calendarClass} />
										</div>
...
{/* <div className={styles.main_basic_information_content_container_toggle}>
	<Toggle label="Autogenerate Password" defaultChecked onText="Yes"  offText="No" styles={toggleStyles} 
	onChange={()=>setAutoGeneratePass(!autoGeneratePass)}/>
		{autoGeneratePass && <div className={styles.main_from_field}>
			<div className={styles.main_sub_from_field}>
				...
				<div>
					<TextField  type="pass" name="pass" disabled={!showPass} value="asDf3Dc#DF" styles={halfField} />
				</div>
			</div>

		</div>}
	<Toggle label="Send Welcome Mail" defaultChecked onText="Yes" offText="No" styles={toggleStyles} />
</div> */}
